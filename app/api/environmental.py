...
@api_bp.route('/environmental-logs', methods=['GET'])
...
@api_bp.route('/environmental-logs', methods=['POST'])
@jwt_required()
...
@api_bp.route('/environmental-logs/<int:log_id>', methods=['GET'])
...
@api_bp.route('/environmental-logs/<int:log_id>', methods=['DELETE'])
@jwt_required()
...
@api_bp.route('/environmental-logs/latest', methods=['GET'])
...
@api_bp.route('/environmental-logs/statistics', methods=['GET'])
...
@api_bp.route('/environmental-logs/batch', methods=['POST'])
@jwt_required()
